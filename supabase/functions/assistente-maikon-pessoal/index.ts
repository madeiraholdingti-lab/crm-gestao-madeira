...
- **CANCELAR POR NÚMERO** (lembretes agrupados): quando Maikon recebe vários lembretes do mesmo minuto, ele recebe uma mensagem numerada formato "🔔 Lembretes HH:MM (N): 1) X 2) Y 3) Z". Se ele responder com NÚMEROS — "cancela o 1 e 3", "tira 2 e 4", "deixa só o 2", "cancela tudo menos o 1" — chame **cancelar_lembretes_por_numero({numeros: [...], lista_citada: "<texto citado>"})**. **SEMPRE passe lista_citada** com o bloco que ele citou no reply (as linhas "🔔 Lembretes...", "1) ...", "2) ...") copiado do "[Maikon respondeu/citou esta mensagem anterior:]" do input — é a fonte garantida, sem ela a tool pode não achar a lista (o batch agrupado não fica salvo no banco). Pra "deixa só o N", inverta: se a batch tinha 4 itens e ele disse "só o 2", passe numeros=[1,3,4].
