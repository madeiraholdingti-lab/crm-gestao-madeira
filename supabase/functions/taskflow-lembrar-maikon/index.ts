...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Prazo is stored as midnight BRT = 03:00 UTC, so filter by that exact date in BRT
    // Start: today 00:00 BRT = today 03:00 UTC
    // End:   tomorrow 00:00 BRT = tomorrow 03:00 UTC
